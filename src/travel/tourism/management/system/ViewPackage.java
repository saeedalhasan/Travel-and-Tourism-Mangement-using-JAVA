...
public class ViewPackage extends JFrame implements ActionListener{
    ...
    public ViewPackage(String username){
        setBounds(450, 240, 900, 450);
        setLayout(null);
        getContentPane().setBackground(Color.WHITE);
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/tourism/management/system/icons/bookedDetails.jpg"));
