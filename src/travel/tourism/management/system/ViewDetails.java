...
public class ViewDetails extends JFrame implements ActionListener{
    ...
    ViewDetails(String username){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/tourism/management/system/icons/viewall.jpg"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("travel/tourism/management/system/icons/viewall.jpg"));
