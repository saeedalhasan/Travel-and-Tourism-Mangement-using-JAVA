...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    AddCustomer(String username){
        ...
        c1 = new JComboBox(new String[] { "Passport", "NID Card", "Birth Cirtificate" });
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("travel/tourism/management/system/icons/newcustomer.jpg"));
