...
public class CheckHotels extends JFrame implements Runnable{
    ...
    CheckHotels(){
        ...
        for(int i = 0; i <= 9; i++){
            image[i] = new ImageIcon(ClassLoader.getSystemResource("travel/tourism/management/system/icons/hotel"+(i+1)+".jpg"));
            jimage[i] =i1.getImage().getScaledInstance(900, 700, Image.SCALE_DEFAULT);
